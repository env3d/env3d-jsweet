...
// Toggle Console method by - Arsh

let consoleToggle = () => {
    document.getElementById("console").classList.toggle("displayConsole");
    if (document.getElementById("consoleArrows").className == "fa fa-angle-double-up")
        document.getElementById("consoleArrows").className = "fa fa-angle-double-down";
    else
        document.getElementById("consoleArrows").className = "fa fa-angle-double-up";
    //resizeEditor();
}
